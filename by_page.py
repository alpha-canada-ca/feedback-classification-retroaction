        ...
        if page_data.empty:
            ...
            if page_data['Lang'][0] == 'EN':
                ...
                page_data_en = page_data[["Comment", "Date", "Status",  "What's wrong", "Lookup_tags",
                                          'Tags confirmed', 'Lookup_page_title', 'Lookup_group_EN', 'Lookup_group_FR']]
                ...
                if lang == 'en':
                    page_data_en['Lookup_tags'] = page_data_en['Lookup_tags'].apply(
                        lambda d: d if isinstance(d, list) else ['Untagged'])
                if lang == 'fr':
                    page_data_en['Lookup_tags'] = page_data_en['Lookup_tags'].apply(
                        lambda d: d if isinstance(d, list) else ['Non-étiquettés'])
            ...
            # process to follow if French
                ...
                if lang == 'en':
                    page_data_fr['Lookup_FR_tag'] = page_data_fr['Lookup_FR_tag'].apply(
                        lambda d: d if isinstance(d, list) else ['Untagged'])
