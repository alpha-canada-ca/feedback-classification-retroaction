        ...
        if page_data.empty:
            ...
            if page_data['Lang'][0] == 'EN':
                ...
                for index in yes_no_db['problemDate']:
                    ...
                    index = arrWords[3] + "-" + \
                        monthDict[arrWords[1]] + "-" + arrWords[2]
                ...
                reasons[["problem"]] = reasons[["problem"]].replace([''], [
                                                                    'None'])
                ...
                reasons_period[["problem"]] = reasons_period[["problem"]].replace([''], [
                                                                                  'None'])
                ...
                by_reason_period = by_reason_period[[
                ...
                if all_data_en.empty:
                    ...
                    all_words_en = ' '.join([str(elem)
                                            for elem in word_list_en])
                    ...
                    if not words_ns_en:
                        ...
                        img = io.BytesIO()
                        wordcloud = WordCloud(
                            background_color='white', max_font_size=100, width=600, height=300).generate(cloud_words)
                    ...
                    if confirmed_en.empty and unconfirmed_en.empty:
                        ...
                        confirmed_en = confirmed_en.drop(
                            columns=['Tags confirmed'])
                        ...
                        confirmed_en['tags'] = [
                            ','.join(map(str, l)) for l in confirmed_en['Lookup_tags']]
                        tags_en = confirmed_en["tags"].str.split(
                            ",", n=3, expand=True)
            ...
            # process to follow if French
                ...
                if all_data_fr.empty:
                    ...
                    all_words_fr = ' '.join([str(elem)
                                            for elem in word_list_fr])
                    ...
                    if confirmed_fr.empty and unconfirmed_fr.empty:
                        ...
                        confirmed_fr = confirmed_fr.drop(
                            columns=['Tags confirmed'])
                        ...
                        # split tags and expand
                        confirmed_fr['tags'] = [
                            ','.join(map(str, l)) for l in confirmed_fr['Lookup_FR_tag']]
                        tags_fr = confirmed_fr["tags"].str.split(
                            ",", n=3, expand=True)
