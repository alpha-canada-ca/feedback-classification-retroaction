    ...
    if group == 'no_group':
        ...
        if group_data.empty:
            ...
            group_data = group_data[["Comment", "Date", "Status",  "What's wrong", "Lookup_tags", 'Tags confirmed',
                                     'Lookup_page_title', 'URL_function', 'Lookup_FR_tag', "Lookup_group_EN", "Lookup_group_FR"]]
            ...
            if lang == 'en':
                group_data['Lookup_tags'] = group_data['Lookup_tags'].apply(
            ...
            if lang == 'en':
                group_data['Lookup_FR_tag'] = group_data['Lookup_FR_tag'].apply(
                    lambda d: d if isinstance(d, list) else ['Untagged'])
            if lang == 'fr':
                group_data['Lookup_FR_tag'] = group_data['Lookup_FR_tag'].apply(
                    lambda d: d if isinstance(d, list) else ['Non-étiquettés'])
